...
<div id="datospersonales"> <!---ID Datos personales--->
  ...
  <div class="col"> 
    ...
    <input  require id="contrasena" type="password" name="contrasena" class="form-control" placeholder="Ingrese su contraseña">
    </div>
    <div class="col">
...
<div id="servicios"> <!--ID servicios--->
  ...
  <div class="row"> <!--Contenedor fila2 "row"descripción servicio certficiaciones-->
    <div class="col">
        <label>Breve Descripción del tus Habilidades:</label>
...
<div class="row"> <!--Contenedor fila3 "row" grado académico y expertiz excel-->
    <div class="col">
      ...
      <input id="descGradoAcad" type="textarea" name="gradoacademico" class="form-control" placeholder="Descripcion Grado Académico">
    </div>
    <div class="col">
