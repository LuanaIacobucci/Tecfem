...
<br>
    ...
    <div class="row">
        <div class="col"> <!---Columna Checkbox Cliente--->
           ...
           <label><input type="checkbox" id="cboxcliente" value="checkbox1" name="cuentacliente"></label><br>
             <p>Cliente</p>
        ...
        <div class="col"> <!---Columna Checkbox Proveedor de servicio--->
          ...
          <label><input type="checkbox" id="cboxproveedor" value="checkbox2" name="cuentaproveedor"></label><br>
